    ...
    <div class="sidebar-wrapper active  ">
        ...
        <div class="sidebar-menu position-relative">
            <ul class="menu">
                ...
                <li class="sidebar-item @yield('masterdata')">
                    <a href="/masterdata" class='sidebar-link'>
                ...
                <li class="sidebar-item @yield('penerimaansurat')">
                    <a href="/penerimaan-surat" class='sidebar-link'>
                        <i class="bi bi-cloud-download"></i>
                        <span>Penerimaan Surat</span>
                    </a>
                </li>
                <li class="sidebar-item @yield('logout') mt-auto">
